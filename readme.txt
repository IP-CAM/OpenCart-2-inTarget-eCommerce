...
## Установка
  ...
  - Установите и включите модуль в разделе *Extensions - Analytics*.
  - Введите **email** и **ключ API** полученные в ЛК [inTarget](https://intarget.ru) и нажмите *Авторизация*.

Более детальную информацию смотрите на сайте [inTarget](https://intarget.ru)

## Модуль "inTarget eCommerce"

Данный модуль находится на панели администрации в разделах *"Extensions"* и *"Analytics"*.
